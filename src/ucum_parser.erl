...
maybe_exponent_digits(<<$0, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$1, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$2, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$3, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$4, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$5, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$6, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$7, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$8, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);

maybe_exponent_digits(<<$9, _/binary>>=String, S0) ->
  exponent_digits(1, String, S0);
